...
token_entry = {
    ...
    "issued_timestamp": os.getenv("TOKEN_ISSUED_DATE")
...
def is_token_expired() -> bool:
    ...
    issued_date = os.getenv("TOKEN_ISSUED_DATE", None)
    access_token = os.getenv("ACCESS_TOKEN", None)
    token_expires_in = int(os.getenv("TOKEN_EXPIRES_IN", 1799))
...
def get_token() -> str:
    if is_token_expired():
        ...
        os.environ["TOKEN_ISSUED_DATE"] = str(issued_timestamp)
        log.info(os.getenv("TOKEN_ISSUED_DATE"))
